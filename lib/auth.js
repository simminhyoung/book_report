...
// Finds a user by their Google account, linking or creating as needed:
// 1) already linked (googleId matches) -> return as-is
// 2) an account with the same email exists (e.g. from before) -> link googleId to it
// 3) brand new -> create a fresh account (no password; Google-only login)
